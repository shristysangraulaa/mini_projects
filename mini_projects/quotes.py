...
"Success means doing the best we can with what we have. Success is the doing, not the getting; in the trying, not the triumph. Success is a personal standard, reaching for the highest that is in us, becoming all that we can be.– Zig Zigla",
...
def quote_oftheday():
    import random
    quote_oftheday = random.randint(0,(len(quotes)-1))
    return(quotes[quote_oftheday])
